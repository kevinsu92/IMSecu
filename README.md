# IMSecu — iM Rookie League 자동 모의투자 시스템

iM증권 대학생 모의투자대회(2026-09-08 ~ 10-08)용 **종가 단일가 1일 1회 리밸런싱** 시스템입니다. Open API 가 없는 HTS(싸이칸 Plus)를 Win32 메시지로 조작해 주문하고, 텔레그램으로 알리며, 로컬 상황판에서 제어합니다. 계좌·필명·자격증명은 자리표시자로 바꾼 공개 사본입니다.
...
- HTS 조작·순위표 조회 코드는 증권사 약관이나 대회 규정에 저촉될 수 있습니다. 사용 책임은 사용자에게 있습니다.
